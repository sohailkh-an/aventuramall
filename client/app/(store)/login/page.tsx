...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-dull rounded-2xl overflow-hidden">
        <div className="px-8 py-10 sm:p-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-foreground tracking-tight">Welcome back</h2>
            <p className="mt-2 text-sm text-foreground">Please enter your details to sign in</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 py-6 placeholder:text-foreground/30 bg-background border-foreground/20 focus:border-brand focus:ring-brand rounded-sm outline-none"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 py-6 placeholder:text-foreground/30 bg-background border-foreground/20 focus:border-brand focus:ring-brand pr-10 rounded-sm outline-none"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-foreground hover:text-brand focus:outline-none transition-colors"
                >
