export const metadata = {
  title: 'Privacy Policy | Galleria Mall Store',
};
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none text-muted-foreground space-y-6">
        <p>
          At Galleria Mall Store, accessible from our website, one of our main priorities is the privacy of our visitors. 
          This Privacy Policy document contains types of information that is collected and recorded by Galleria Mall Store 
          and how we use it.
        </p>
        ...
        <p>
          Galleria Mall Store follows a standard procedure of using log files. These files log visitors when they visit 
        ...
        <p>
          Like any other website, Galleria Mall Store uses "cookies". These cookies are used to store information including 
        ...
        <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">5. Third-Party Privacy Policies</h2>
        <p>
          Galleria Mall Store's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you 
